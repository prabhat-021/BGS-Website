(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/components_6e30ecd5._.js", {

"[project]/components/Mousefollower.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const MouseFollower = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MouseFollower.useEffect": ()=>{
            const moveCursor = {
                "MouseFollower.useEffect.moveCursor": (e)=>{
                    setPosition({
                        x: e.clientX,
                        y: e.clientY
                    });
                }
            }["MouseFollower.useEffect.moveCursor"];
            window.addEventListener("mousemove", moveCursor);
            return ({
                "MouseFollower.useEffect": ()=>window.removeEventListener("mousemove", moveCursor)
            })["MouseFollower.useEffect"];
        }
    }["MouseFollower.useEffect"], []);
...
_s(MouseFollower, "jv34aNIyPo+g3wMR9igNqlVW3h8=");
_c = MouseFollower;
...
_s(Navbar, "4wPE8RvFzqJIYcNbVYbX1F9RkVU=", false, function() {
    return [
...
//# sourceMappingURL=components_6e30ecd5._.js.map